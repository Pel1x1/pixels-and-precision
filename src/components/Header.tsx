  ...
  return (
    <header className="w-full px-4 sm:px-6 lg:px-8 py-6">
      <div className="max-w-7xl mx-auto">
        <nav className="flex items-center justify-between lg:justify-start lg:gap-8 xl:gap-12">
          <img
            ...
            className="aspect-[0.97] object-contain w-20 sm:w-24 lg:w-[100px] shrink-0"
            alt="НЮКТА логотип"
          />
          
          {/* Desktop Navigation */}
          <div className="hidden lg:flex items-center gap-6 xl:gap-8 text-2xl xl:text-3xl text-[rgba(19,54,92,1)] font-arsenal">
          ...
          {/* Mobile Menu Button */}
          <button className="lg:hidden p-2 text-[rgba(19,54,92,1)]">
